...
benchmark_engine::benchmark_engine() : next_orderid{1} {};

std::pair<orderid_t, std::vector<execution_t>> benchmark_engine::limit(order_t order) noexcept {
...
bool benchmark_engine::cancel(orderid_t orderid) noexcept {
